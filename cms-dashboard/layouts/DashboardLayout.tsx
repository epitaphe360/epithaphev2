...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ config, children }) => {
  ...
  const navigation = [
    ...
    { name: 'Ressources',    href: '/admin/resources',          icon: FolderOpen,      group: 'content' },
    { name: 'Éditeur visuel', href: '/admin/visual-editor',     icon: Layers,          group: 'content' },
    { name: 'Solutions',     href: '/admin/solutions',          icon: Lightbulb,       group: 'content' },
