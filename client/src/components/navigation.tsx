...
const defaultNavConfig: NavEntryConfig[] = [
  {
    ...
    mega: true,
    href: "/evenements",
    previewImage: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80",
    entries: [
      { label: "Conventions & Kickoffs",   description: "Fédérez vos équipes autour de vos ambitions",    href: "/evenements/conventions-kickoffs",  icon: "Calendar", previewImage: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80" },
      { label: "Soirées de gala",          description: "Créez des moments d'exception inoubliables",     href: "/evenements/soirees-de-gala",       icon: "Trophy", previewImage: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=800&q=80" },
      { label: "Roadshows & Tournées",     description: "Portez votre message dans toute la région",      href: "/evenements/roadshows",    icon: "Truck", previewImage: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&q=80" },
      { label: "Salons & Expositions",     description: "Maximisez votre visibilité sur les salons B2B",  href: "/evenements/salons",    icon: "Store", previewImage: "https://images.unsplash.com/photo-1561489396-888724a1543d?w=800&q=80" },
    ],
  },
  {
    ...
    previewImage: "https://version2.epitaphe.ma/wp-content/uploads/2025/11/marque-employeur-maroc-700x1012.jpg",
    entries: [
      { label: "Marque Employeur",    description: "Attirez et retenez les meilleurs talents",    href: "/architecture-de-marque/marque-employeur",   icon: "Briefcase", previewImage: "https://version2.epitaphe.ma/wp-content/uploads/2025/11/marque-employeur-maroc-700x1012.jpg" },
      { label: "Communication QHSE", description: "Sécurité & conformité avec impact visuel",    href: "/architecture-de-marque/communication-qhse", icon: "ShieldCheck", previewImage: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80" },
      { label: "Expérience Clients", description: "Différenciation et fidélisation durables",    href: "/architecture-de-marque/experience-clients", icon: "Users", previewImage: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80" },
    ],
  },
  {
    label: "La Fabrique",
    ...
    entries: [
      { label: "Branding de Siège",      description: "Habillage siège social, murs de marque",     href: "/la-fabrique/branding-siege", icon: "Building2", previewImage: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80" },
      { label: "Impression grand format", description: "Bâches, adhésifs, toiles rétroéclairées",     href: "/la-fabrique/impression",    icon: "Printer", previewImage: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80" },
      { label: "Menuiserie & Décor",      description: "Stands sur mesure, mobilier d'ambiance",      href: "/la-fabrique/menuiserie",    icon: "Hammer", previewImage: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=800&q=80" },
      { label: "Signalétique",            description: "Totems, enseignes, wayfinding professionnel", href: "/la-fabrique/signaletique",  icon: "Signpost", previewImage: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80" },
      { label: "Aménagement Espace",      description: "Scénographie & architecture éphémère",        href: "/la-fabrique/amenagement",   icon: "LayoutGrid", previewImage: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800&q=80" },
    ],
  },
